#Diego Espinola
#04.13.2020
#continuation from the sort methods, this program shows how munch a method takes
...
while choice != 6:
    ...
    if choice == 1:
        ...
        my_list = sort_methods.bubble_sort(my_list)
        ...
        qty = fill_list()
        start_time = time.time()
        my_list = sort_methods.selection_sort(my_list)
        ...
        qty = fill_list()
        start_time = time.time()
        my_list = sort_methods.insertion_sort(my_list)
        print(f"** It takes {(time.time() - start_time)} seconds to complete a Bubble Sort with {qty} values **")
        ...
        qty = fill_list()
        start_time = time.time()
        my_list = sort_methods.merge_sort(my_list)
        print(f"** It takes {(time.time() - start_time)} seconds to complete a Bubble Sort with {qty} values **")
        ...
        qty = fill_list()
        start_time = time.time()
        my_list = sort_methods.quick_sort(my_list)
        print(f"** It takes {(time.time() - start_time)} seconds to complete a Bubble Sort with {qty} values **")
